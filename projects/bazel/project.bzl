...
#
#   bazel run //projects/bazel:build_local_linux_amd64 -- //src:bazel-bin
#   bazel run //projects/bazel:test_local_linux_amd64
#   bazel run //projects/bazel:test_rbe_linux_amd64
#
