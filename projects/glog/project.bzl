...
GLOG_PROJECT = project_spec(
    name = "glog",
    source = tarball_source(
        archive = "@glog_archive//file",
    ...
    test = test_spec(targets = ["//bazel/example:main"], flags = ["-c", "opt"]),
)
